...
const CloseRequest = ({ id, index, setRequests, closeModal }) => {
    ...
    const handleApprove = async () => {
        try {
          ...
          toast.success("درخواست بسته شد", toastOption);
        } catch (err) {
          if (err.response) {
    ...
    return (
        <Container>
            <Typography variant="body2">آیا از بستن درخواست اطمینان دارید؟</Typography>
